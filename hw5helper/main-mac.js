...
app.get ('/login', function (req, res) {
	...
	shelljs.exec('./login ' + name, function(code, stdout, stderr) {
...
app.get ('/writelog', function (req, res) {
	...
	shelljs.exec ('./writeLog ' + filename + ' ' + shellStr, function (code, stdout, stderr) {
	  console.log('Exit status:'+ code);
	  console.log('Exit output:'+ stdout);
...
app.get ('/readlog', function (req, res) {
	...
	shelljs.exec ('./readLog ' + filename, function (code, stdout, stderr) {
	  console.log('Exit status:'+ code);
	  console.log('Exit output:'+ stdout);
