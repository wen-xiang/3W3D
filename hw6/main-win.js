...
app.get ('/writelog', function (req, res) {
	...
	//var filename = "7777720170601.log";
	...
	shelljs.exec ('writeLog.exe ' + ".\\log\\" + filename + ' ' + shellStr, function (code, stdout, stderr) {
	  console.log('Exit status:'+ code);
	  console.log('Exit output:'+ stdout);
...
app.get ('/readlog', function (req, res) {
	...
	shelljs.exec ('readLog.exe ' + ".\\log\\" + filename, function (code, stdout, stderr) {
	  console.log('Exit status:'+ code);
	  console.log('Exit output:'+ stdout);
...
app.get ('/getFileName', function (req, res) {
	...
	shelljs.exec ('getFileName.exe ' + name, function (code, stdout, stderr) {
	  console.log('How many:'+ code);
	  console.log('Have file:'+ stdout);
